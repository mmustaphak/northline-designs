...
export default function CaseStudyCard({ className }: { className?: string }) {
	return (
		<a href="/" className="contents">
			<div
				className={`${className} font-semibold border rounded-sm border-grey`}
			>
				<img
				...
				<div className="flex items-center justify-between p-3">
					<div>
						...
						<p className="text-xs max-[320x]:text-xs text-muted-foreground">
							SportsTech Mobile App
						</p>
					</div>
					<p className="text-blue max-[320x]:text-xs text-sm flex items-center w-fit">
