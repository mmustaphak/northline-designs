    ...
    <>
      <section>
        ...
        <p className="page-description">
          What We Do Comprehensive design solutions for digital products. We partner with ambitious
          companies to build interfaces that perform beautifully.
        </p>
      </section>
      <section>
      ...
      <section className="bg-[#D9E3F4] max-w-none! py-14!">
        <div className="wrapper">
          ...
          <Link to="/submit-a-project" className="button-link-light inline-block mt-10">
            START A PROJECT
          </Link>
        </div>
      </section>
