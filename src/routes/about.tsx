...
function About() {
	const principles = [
		...
		{
			title: "IMPACT",
			description: "Creating experiences that deliver real value.",
		},
	];
	return (
		<>
			<section>
				<div className="md:flex gap-x-4 md:items-stretch justify-center">
					...
					<div className="text-center font-semibold">
						<h2 className="md:mt-0! md:font-bold md:text-4xl!">
							Abdulrahman Adejumo
						</h2>
						...
						<p className="text-muted-foreground mt-6 max-w-120 md:text-left md:text-sm lg:text-base">
							...
							startups, businesses, and product teams to turn complex ideas into
							simple, functional, and engaging digital products and strong
							visual identities. From mobile apps, websites, SaaS platforms, and
							dashboards to brand identities, marketing graphics, and visual
							assets, we combine strategic thinking, user-centered design, and
							thoughtful visuals to create work that is both beautiful and
							effective. We believe great design goes beyond aesthetics, it
							solves problems, builds strong brands, simplifies experiences, and
							creates meaningful connections between people and technology.
						</p>
					</div>
				</div>
				...
				<div className="text-center mt-8">
					...
					<div className="md:flex gap-x-4 mt-10">
						{principles.map(({ title, description }) => (
							<div
								key={title}
								className="mb-2 border-l text-left pl-4 border-grey"
							>
